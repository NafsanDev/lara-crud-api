                ...
                <tbody class="divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100 transition">
                        ...
                        <td class="px-4 py-3 flex justify-center space-x-2">
                            <a href="{{ route('blog.show') }}" class="px-3 py-1 bg-blue-500 text-white text-xs font-semibold rounded shadow-md hover:bg-blue-600 transition">
                                👁 View
                            </a>
                            <a href="{{ route('blog.edit') }}" class="px-3 py-1 bg-yellow-500 text-white text-xs font-semibold rounded shadow-md hover:bg-yellow-600 transition">
                                ✏️ Edit
                            </a>
